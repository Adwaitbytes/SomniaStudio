...
export async function settlePayment(payload: Q402Payload) {
  try {
    ...
    const chain = payload.paymentDetails.networkId === 'somnia-mainnet' ? somniaMainnet : somniaTestnet;
    ...
    if (amountBig > parseEther("0.1")) { // Max 0.1 STT/SOMI Settlement
    ...
    // For this Demo on Somnia Testnet, the Facilitator 
